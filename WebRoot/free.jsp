...
<%@ page import="org.wzz.ifttt.response.Member.Task, org.wzz.ifttt.response.Member.Login, org.wzz.ifttt.response.Member.Register"%>
<!DOCTYPE html> 
<html> 
  	<head> 
		<meta charset='utf-8'> 
		...
		<script language="JavaScript">
			function checklen(f) {
			if(f.user[realname].value.length==0) {
				alert("请输入真实姓名！");
				f.realName.select();
				return false;
			}
			var str = f.user[birthday].value;
						...
						<form action="./IFTTT_Store_Data.jsp" autocomplete="off" id="signup_form" method="post">
							<div style="margin:0;padding:0;display:inline">
  							...
  							<div class="fieldgroup"> 
    							<div class="fields" id="user_signup_fields"> 
    								<dl class="form autocheck" id="user_signup_username" style="display:inline"> 
      								...
      								<dl class="form autocheck" id="user_signup_password"> 
  							...
  							<div class="form-actions"> 
   			 						<button type="submit" class="classy primary js-oneclick" id="signup_button" ><span>Create an account</span></button> 
  								</div> 
						</form> 
					</div><!-- /.column.main --> 
