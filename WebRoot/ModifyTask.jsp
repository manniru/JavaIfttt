...
<html> 
	...
	-->
  	...
  	<body class="logged_in  windows  env-production " onLoad="addOnClickHandlers();">            
		...
		<a href='http://www.baidu.com' rel='iframe' title='baidu :: æå¼BAIDU :: width: 800, height: 600'
		...
		<div class="columns accountcols"> 
			<form action="/liangweb/CreateTask.jsp" method="post">
  				<div class="main"> 
					...
					<div>
      				...
      				<dl class="form"> 
    					...
    					<dd><input error="false" id="task_name" name="task[name]" size="30" style="width:39em" type="text" value="<%=request.getParameter("task[name]") %>"/></dd></dl> 
 
      				<dl class="form"> 
        				<dt><label for="task_description">Description</label> <small style="font-weight:normal">(optional)</small></dt> 
        				<dd><input id="task_description" name="task[description]" size="30" style="width:39em" type="text" value="<%=request.getParameter("task[description]") %>"/></dd> 
      				</dl> 
 					...
 					<div class="rule"></div>
      				...
      				<p class="checkbox"> 
       	 				<label> 
            				<a href="/account/billing" class="action">Upgrade your plan to modify advanced tasks!</a> 
       		 			</label> 
      				</p> 
 
 
      				<div class="form-actions"> 
        				<button type="submit" class="classy primary js-oneclick" data-afterclick="Creating Repositoryâ..."> 
    				...
    				<div class="fieldgroup" id="this_fieldgroup"> 
      					...
      					<div class="note">love me, please
							...
							<div id="weibo_event_form" style="display:none">
								...
								<dl class="form"> 
        							<dt><label for="weibo_event_keyword">Weibo Keyword</label></dt> 
							...
							<div id="gmail_event_form" style="display:none">
								<dl class="form"> 
        							<dt><label for="gmail_event_name">Gamil Username</label></dt> 
